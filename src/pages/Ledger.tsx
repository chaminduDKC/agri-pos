...
interface LedgerRecord {
  ...
  created_at: string;
  // TODO(Chamindu): replace with real lookups from your projects/sub_projects arrays
  project_name?: string;
...
const Ledger = () => {
  ...
  const [editingMode, setEditingMode] = useState(false);
    ...
    const getChildProjectsForSelectedSubProject = async (id: string) => {
        console.log("Fetching childs for id", id)
    ...
    const handleSave = async () => {
        ...
        console.log(form.completed_child_ids)
